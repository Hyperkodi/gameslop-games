...
test('every source rectangle and foot anchor is inside its actual sprite atlas',()=>{
 ...
 const all=[{atlas:skin.mascot.atlas,frames:Object.entries(skin.mascot.frames).map(([key,rect])=>({rect,anchor:skin.mascot.anchors[key]}))},...Object.values(skin.companions),...Object.values(skin.cast.enemies),...skin.cast.bosses];
