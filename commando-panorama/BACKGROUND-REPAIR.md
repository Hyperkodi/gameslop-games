...
The repaired version is published separately at https://hyperkodi.github.io/gameslop-games/commando-panorama/ . The preserved original remains at https://hyperkodi.github.io/gameslop-games/commando/ . Use `background-review.html` beside this file to compare all six scrolling stages at matching camera positions.
...
The original release is Git tag `pepontra-before-background-repair-20260913`, commit `183800d4a275d19075296ebcf702eeacee0a1710`, in `Hyperkodi/gameslop-games`. This preview does not replace its `commando/` directory.
