...
(function(root){
 ...
 if(typeof module==='object'&&module.exports){module.exports={matches};return;}
 ...
 const api=root.SlopperNativeTitle={matches,get state(){return {visible,reads,hits};}};
 function observe(gl){
  const now=performance.now();if(now-lastRead<(visible?100:350))return;
