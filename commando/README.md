...
The new user-provided soundtrack uses `Soundtrack/1.mp3` through `8.mp3`, matching stages 1–8. Each track loops through one decoded Web Audio source at a time. `music-credits.html` previews these numbered tracks. `Level Victory.mp3` starts after the boss explosion and continues into the completion menu. The quieter effects mix remains in place.
